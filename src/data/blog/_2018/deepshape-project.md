...
pubDatetime: 2018-10-11T00:30:36Z
description: "We then turn to predict RNA motif (especially RNA-protein interaction related motif). It is another harder problem compared with \"simply\" applying deep neural network to 1D and 2D structure data. We develop the mixture model for PWM optimization. We explore the possibility to use VAE for unsupervise"
author: "James Chen"
