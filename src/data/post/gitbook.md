...
publishDate: 2018-05-04T02:01:38Z
excerpt: "之前用过一些，比如： - 帮老板写过书里的一章(5.1 eMaize Challenge  · 生物信息学实践) - training课的一些notes(Introduction · Bioinfo Training - Shared - 2018)，后来又移到github的wiki上了(Home · lulab/training Wiki · GitHub) - 还把爷爷的回忆录也用markdown整理了一遍放到gitbook上(爷爷回忆录)，（一文多用，之前也已经放到blog上面了），排版比word辛辛苦苦排来排去随便一弄就全乱了是强太多了。"
author: "James Chen"
